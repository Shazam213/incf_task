...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\soham\\Desktop\\gsoc\\incf\\grating_acuity_task_lastrun.py',
...
GA = visual.GratingStim(
    ...
    ori=0.0, pos=[0,0], size=[32,64], sf=1.0, phase=0.0,
