...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\soham\\Desktop\\gsoc\\incf\\contrast sensitivity task\\contrast_sensitivity_task_lastrun.py',
...
for thisGA_loop in GA_loop:
    ...
    for thisTrial in trials:
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        position = (randchoice([-1, 1])*16, randchoice([-1, 1])*8)  # Set routine start values for position
